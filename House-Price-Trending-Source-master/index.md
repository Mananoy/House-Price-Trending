...
<script>
    ...
    function initMap() {
      ...
      map.data.addListener("mouseover", (event) => {
         if (!event.feature.getProperty("selected"))
         {
            ...
            $.getJSON( "https://pages.github.cs.adelaide.edu.au/a1781326/House-Price-Trending-Source/script/Suburb2019.json", function( data ) {
               validity = false;
    ...
    function updateChart(suburb_name){
       ...
       $.getJSON( "https://pages.github.cs.adelaide.edu.au/a1781326/House-Price-Trending-Source/script/Suburb2019.json", function( data ) {
          ...
          $.each(data, function(key, value) {
              if (key == suburb_name)
              {
                 //console.log("found in map with name:");
                 //console.log(key);
                 place = value.id
                 document.getElementById('selected_suburb_name').innerHTML = key;
              }
          });
          if (place == " ")
          {
    ...
    function change_date(str){
      ...
      // placeCombi
      $.getJSON( "https://pages.github.cs.adelaide.edu.au/a1781326/House-Price-Trending-Source/script/SuburbCombi.json", function( data ) {
         var index = 2;
         $.each(data, function(key, value) {
             value.id = array[index];
             index = index + 1;
...
<div id="main">
   <nav class="sticky">
      <ul class="menubar">
         <li class="menubar active"><a href="https://pages.github.cs.adelaide.edu.au/a1781326/House-Price-Trending/"><i class="fas fa-home"></i> Home</a></li>
         <li class="menubar"><a href="https://pages.github.cs.adelaide.edu.au/a1781326/House-Price-Trending/pages/404"><i class="fas fa-house-user"></i> Option2</a></li>
         <li class="menubar"><a href="https://pages.github.cs.adelaide.edu.au/a1781326/House-Price-Trending/pages/404"><i class="fas fa-archive"></i> Option3</a></li>
         <li class="menubar"><a href="https://pages.github.cs.adelaide.edu.au/a1781326/House-Price-Trending/pages/404"><i class="fas fa-address-card"></i> Option4</a></li>
      </ul>
   </nav> 
   ...
   <!--<br>-->
   <!--<div style="text-align: center;">-->
      <!--<a class="btn btn-primary" href="https://pages.github.cs.adelaide.edu.au/a1781326/House-Price-Trending/pages/404" role="button">404</a>-->
   <!--</div>-->
